 ...
 const [email, setEmail] = useState('');
  ...
  const handleLogIn = async (e) => {
    ...
    try {
      ...
      alert(`Welcome, ${userCredential.user.email}! Account Log Succesful.`);
navigate('/');
    } catch (error) {
 ...
 return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
      <div className=" bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md">
        <h1 className="text-3xl font-bold mb-6 text-yellow-400 text-center">Log-in to Your Account</h1>
        

        {error && <p className="text-red-500 mb-4 text-center border border-green-500 p-2 rounded font-bold italics">{error}</p>}
        ...
        <form onSubmit={handleLogIn} className="space-y-4">
          ...
          <div>
            ...
            <input 
              ...
              required
              className="w-full p-3 rounded bg-gray-700 border border-gray-600 focus:ring-blue-400 focus:border-blue-400 text-white"
            />
          </div>
